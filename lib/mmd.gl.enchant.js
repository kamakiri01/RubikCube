...
(function() {
    ...
    enchant.gl.mmd.MSkeleton = enchant.Class.create(enchant.gl.Skeleton, {
        ...
        _add: function(param) {
            ...
            console.log(this.table.length + "tabel length");
            if (param.parent_bone_index == 0xFFFF) {
                console.log(this.table[param.parent_bone_index] + "parent"); //mydebug
                this.addChild(bone);
            } else {
                console.log(param.parent_bone_index); //mydebug
                console.log(this.table[param.parent_bone_index]); //mydebug
                //myadd
                if(this.table[param.parent_bone_index] != undefined){
